...
<!-- Forgive us for this messy markup. It is copied from an old legacy system -->
            ...
            <c:if test="${search}">
                ...
                <div id="myTabContent" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="view" aria-labelledBy="view-tab">
                        ...
                        <table class="dataTable">
                            <tr>
                                <c:forEach var="pair" items="${last24}" varStatus="loopStatus">
                                    <c:set var="foo" value="${loopStatus.index % 2 == 0 ? 'even' : 'odd'}" />
                                    <c:if test="${foo == 'even'}">
