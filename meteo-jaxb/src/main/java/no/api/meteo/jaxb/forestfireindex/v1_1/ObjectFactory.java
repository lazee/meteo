 ...
 * generated in the no.api.meteo.jaxb.forestfireindex.v1_1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _LocationTypeProbability_QNAME = new QName("", "probability");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: no.api.meteo.jaxb.forestfireindex.v1_1
     * 
     */
