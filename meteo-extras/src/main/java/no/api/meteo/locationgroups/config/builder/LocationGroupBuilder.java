...
package no.api.meteo.locationgroups.config.builder;
...
@NoArgsConstructor
public class LocationGroupBuilder implements EntityBuilder<LocationGroup> {
    ...
    public LocationGroup build() {
        return new LocationGroup(id, locations);
    }
}
